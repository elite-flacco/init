...
// Helper function to get user ID from auth header (optimized for speed)
...
export async function GET(
  ...
  try {
    ...
    console.error(
      "Unexpected error in GET /api/user/destinations/[id]:",
      error,
    );
    return NextResponse.json(
...
export async function PUT(
  ...
  try {
    ...
    console.error(
      "Unexpected error in PUT /api/user/destinations/[id]:",
      error,
    );
    return NextResponse.json(
      { error: "Internal server error" },
...
export async function DELETE(
  ...
  try {
    ...
    console.error(
      "Unexpected error in DELETE /api/user/destinations/[id]:",
      error,
    );
    return NextResponse.json(
      { error: "Internal server error" },
