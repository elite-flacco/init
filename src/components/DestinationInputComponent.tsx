...
export function DestinationInputComponent({ travelerType, onSubmit }: DestinationInputComponentProps) {
  ...
  const getExpeditionMessage = () => {
    const messages = {
      ...
      'Type A': "Perfect planning starts with the perfect destination. Where's your target?",
      'Typical Overthinker': "Stop overthinking - just tell us where your heart wants to go!",
      'Just Here to Chill': "Let's find your paradise. What destination calls to your soul?"
    }
    return messages[travelerType.name as keyof typeof messages] || "Where shall we begin this adventure?"
  }
  ...
  const getExpeditionSubtext = () => {
    const subtexts = {
      ...
      'Typical Overthinker': "🧠 We'll make all the tough choices so you can just enjoy.",
      'Just Here to Chill': "🌊 Pure relaxation mode activated - stress-free planning ahead."
    }
    return subtexts[travelerType.name as keyof typeof subtexts] || "✨ Your perfect adventure awaits."
  }
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-background via-background-soft to-background-muted relative overflow-hidden">
      ...
      <div className="absolute inset-0 pointer-events-none">
        <div className="absolute top-16 left-12 text-4xl opacity-10 animate-float">🧭</div>
        <div className="absolute top-32 right-16 text-3xl opacity-15 animate-pulse-slow" style={{ animationDelay: '1s' }}>📍</div>
        <div className="absolute bottom-32 left-20 text-5xl opacity-10 animate-bounce-subtle" style={{ animationDelay: '2s' }}>🗺️</div>
        <div className="absolute bottom-20 right-32 text-4xl opacity-20 animate-float" style={{ animationDelay: '0.5s' }}>✈️</div>
      </div>
          ...
          <div className={`text-center mb-16 transition-all duration-1000 ${
            ...
            <div className="inline-flex items-center justify-center mb-8">
              <div className="relative">
                ...
                <div className="absolute -top-2 -right-2 text-2xl animate-bounce-subtle" style={{ animationDelay: '1s' }}>
                  🎯
                </div>
              </div>
            </div>
          ...
          <div className={`max-w-2xl mx-auto transition-all duration-1000 delay-300 ${
            ...
            <div className="relative">
              ...
              <div className="relative bg-gradient-to-br from-background/95 to-background-card/90 backdrop-blur-xl border-2 border-border/50 rounded-3xl shadow-adventure-float p-8 lg:p-12">
                ...
                {/* Expedition Pattern */}
                <div className="absolute top-4 right-4 text-xl opacity-20 animate-spin-slow">🧭</div>
                ...
                <div className="mt-10 ml-8 lg:ml-16 mr-4 p-6 bg-gradient-to-br from-accent/10 via-transparent to-primary/10 border border-primary/20 rounded-2xl transform -rotate-1">
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      <h4 className="font-semibold text-foreground mb-2">Explorer's Pro Tips:</h4>
                      <ul className="space-y-1 text-sm text-foreground-secondary">
                        <li>• Be specific: "Kyoto bamboo forest" &gt; "Japan"</li>
                        <li>• Include your vibe: "Buenos Aires tango districts"</li>
                        <li>• Mix known + unknown: "Iceland + surprise Nordic spot"</li>
                      </ul>
                    </div>
                  </div>
                </div>
