...
export const destinations: Destination[] = [
  {
    ...
    highlights: [
      {
        name: "Super super super supser long named Beautiful beaches",
        description:
          "Stunning white sand beaches with turquoise waters perfect for swimming and relaxation",
      },
      {
        name: "Ancient temples",
        description:
          "Sacred Hindu temples with intricate architecture and spiritual significance",
      },
      {
        name: "Rice terraces",
        description:
          "Breathtaking emerald green terraced landscapes that showcase traditional farming",
      },
      {
        name: "Yoga retreats",
        description:
          "World-class wellness centers and yoga studios in serene natural settings",
      },
    ],
    ...
    highlights: [
      {
        ...
        description:
          "Spectacular aurora borealis displays dancing across the winter sky",
      },
      {
        name: "Geysers",
        description:
          "Natural hot springs shooting steaming water high into the air",
      },
      {
        name: "Waterfalls",
        description:
          "Powerful cascades like Gullfoss and Skógafoss amid dramatic landscapes",
      },
      {
        name: "Blue Lagoon",
        description:
          "Geothermal spa with mineral-rich milky blue waters for ultimate relaxation",
      },
    ],
    ...
    highlights: [
      {
        name: "Ancient temples",
        description:
          "Historic shrines and temples showcasing traditional Japanese architecture",
      },
      {
        name: "Cherry blossoms",
        description:
          "Beautiful sakura season with pink petals creating magical landscapes",
      },
      {
        name: "Modern cities",
        description:
          "Futuristic urban landscapes with neon lights and cutting-edge technology",
      },
      {
        name: "Amazing food",
        description:
          "World-class cuisine from sushi and ramen to innovative fusion dishes",
      },
    ],
    ...
    highlights: [
      {
        ...
        description:
          "Explore lush cloud forests teeming with exotic wildlife and plants",
      },
      {
        name: "Wildlife viewing",
        description:
          "Spot colorful birds, monkeys, sloths, and other incredible creatures",
      },
      {
        name: "Zip-lining",
        description: "Soar through the canopy on thrilling zip-line adventures",
      },
      {
        name: "Pristine beaches",
        description: "Relax on unspoiled Pacific and Caribbean coastlines",
      },
    ],
    ...
    highlights: [
      {
        name: "Ancient ruins",
        description:
          "Explore millennia-old archaeological sites like the Acropolis and Delphi",
      },
      {
        name: "Island hopping",
        description:
          "Discover unique islands each with distinct character and beauty",
      },
      {
        name: "Mediterranean cuisine",
        description:
          "Savor fresh seafood, olive oil, feta cheese, and local wines",
      },
      {
        name: "Sunset views",
        description:
          "Witness breathtaking sunsets over the Aegean Sea from clifftop villages",
      },
    ],
    ...
    highlights: [
      {
        ...
        description:
          "Bungee jumping, skydiving, and extreme sports in epic locations",
      },
      {
        name: "Stunning landscapes",
        description:
          "Dramatic mountains, fjords, and pristine wilderness scenery",
      },
      {
        name: "Hobbiton",
        description:
          "Visit the movie set from Lord of the Rings in the rolling green hills",
      },
      {
        name: "Milford Sound",
        description:
          "Cruise through the spectacular fiord surrounded by towering peaks",
      },
    ],
