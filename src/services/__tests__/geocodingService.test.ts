...
describe("GeocodingService", () => {
  ...
  it("should geocode a place successfully", async () => {
    ...
    const result = await GeocodingService.geocodePlace(
      "Senso-ji Temple",
      "Tokyo",
      "Japan",
      "attraction",
  ...
  it("should use cached results for repeated queries", async () => {
    ...
    // First call
    const result1 = await GeocodingService.geocodePlace(
      "Senso-ji Temple",
      "Tokyo",
      "Japan",
    );
    ...
    const result2 = await GeocodingService.geocodePlace(
      "Senso-ji Temple",
      "Tokyo",
      "Japan",
    );
  ...
  it("should batch geocode multiple places", async () => {
    ...
    const results = await GeocodingService.geocodePlaces(
      places,
      "Tokyo",
      "Japan",
    );
  ...
  it("should use place type for better search queries", async () => {
    ...
    await GeocodingService.geocodePlace(
      "Restaurant Name",
      "Tokyo",
      "Japan",
      "restaurant",
